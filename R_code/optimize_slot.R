#For example, you could rewrite get_symbols to generate n slot 
#combinations and return them as an n × 3 matrix
...
# write score_many, a vectorized (matix-ized?) version of score
# that takes an n × 3 matrix and returns n prizes
